    ...
    <div ref={setRef} className="max-w-4xl mx-auto px-4 py-12">
      ...
      >
        ...
        <p className="text-lg text-gray-600 mb-8">
          Passionate about blending technology with creativity to solve complex
          challenges.
        </p>
      </div>
      ...
      >
        <div>
          ...
          <p className="text-lg text-gray-600">
            As a Software Engineering student at Carleton University, I'm deeply
            engaged in transforming ideas into reality through coding and
            robotics, exploring new technologies, and building projects that
            matter.
          </p>
        </div>
