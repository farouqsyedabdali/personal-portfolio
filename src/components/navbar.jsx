...
const Navbar = () => {
  const toggleTheme = (event) => {
    const theme = event.target.checked ? "retro" : "dark"; // Assuming 'light' as the default theme
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem("theme") || "dark"; // Default to 'light' if nothing is stored
    document.documentElement.setAttribute("data-theme", savedTheme);
    // If the saved theme is 'pastel', update the checkbox state
    if (savedTheme === "retro") {
    ...
    <div className="navbar bg-base-200 z-10">
      ...
      <div className="navbar-end z-10">
        <label className="swap swap-rotate">
          ...
          <input type="checkbox" className="theme-controller" value="retro" onChange={toggleTheme}/>
